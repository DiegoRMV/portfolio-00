...
const About = () => {
	...
	return (
		<section
			name="< sobre mi />"
			className="w-full dark:bg-fondito2 bg-light0 text-white px-4 py-8 md:py-12 mx-auto"
		>
			<div className="max-w-screen-xl flex flex-col justify-center w-full h-full gap-6">
