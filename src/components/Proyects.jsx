...
import perros from "../assets/images/perros2.avif";
import gamecenter from "../assets/images/gameCenter.avif";
import studioTatto from "../assets/images/studiotatuaje.avif";
import pomodoro from "../assets/images/pomodoro.avif";
...
const Proyects = () => {
	...
	return (
		<>
			...
			>
				<div className="max-w-screen-xl px-4 py-20 mx-auto flex flex-col justify-center w-full h-full">
					<div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 h-full mt-3 w-full gap-12">
						{portfolios.map(({ id, src, title, href, code, parrafo, tech }) => (
							<div
								key={id}
								className="dark:shadow-sm hover:scale-[1.02] duration-500 dark:bg-slate-200 xl:gap-16 border-solid border-2 border-slate-600 p-3 flex flex-col h-full w-full"
							>
								...
								<div className="flex flex-col h-1/2 justify-between text-center">
									...
									<div className="flex flex-row justify-around mt-6 ">
										<a
											...
											target="_blank"
											rel="noreferrer"
											className="dark:text-nuevoWhite bg-nuevo3 font-cardo cursor-pointer  font-semibold  text-slate-50  rounded-md px-5 py-1 w-24"
										>
											Deploy
										</a>
										<a
